...
def run_paper_trade_gate(
    days: int = 10,
    min_sharpe: float = 0.0,      # minimum acceptable Sharpe (must not lose money)
    ...
    if al_pct is not None and al_pct > 25:
        issues.append(f"All-lose {al_pct:.1f}% exceeds 25% threshold — too many losing days")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--min-sharpe", type=float, default=0.0, help="Minimum acceptable Sharpe")
